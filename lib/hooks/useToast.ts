 ...
 *
 * El objeto retornado está memoizado para prevenir re-renders innecesarios
 * cuando se usa en dependencias de useEffect.
 *
...
export function useToast() {
  return useMemo(
    ...
    [] // Array vacío: sonnerToast es estable, el objeto memoizado se mantiene entre renders
  );
}
